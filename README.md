...
Please visit the [Support Forum](https://github.com/makerspet/support/discussions?discussions_q=)!

**UPDATE 2026, June 3**
- [Pythonic port](https://github.com/kaiaai/lds2d) of this library is available on PyPi.org as lds2d
- Arduino and Raspberry Pi 4/5 with LiDARs tutorials available here [https://makerspet.com/learn/]
...
- LDS08RR (aka Revo LDS used in Roborock & 3irobotix CRL-200S platform)
...
- 3irobotix Delta-2C PRO - use `LDS_DELTA_2C_115200`. Protocol version 0x13 or 0x11 (two unit revisions, identical frame layout) with an extra end_angle field (differs from Delta-2A); distance scale 0.25 mm/unit as in the rest of the Delta family, tape-measure verified. Contributed by [sylvan-he](https://github.com/hapynfdj) from the [delta2c-lidar](https://github.com/hapynfdj/delta2c-lidar) reverse-engineering toolkit ([issue #16](https://github.com/kaiaai/LDS/issues/16), [discussion #95](https://github.com/makerspet/support/discussions/95)). The 0x11 revision is hardware-confirmed (thanks to [rolandslepcik98](https://github.com/rolandslepcik98-creator)); the 0x13 revision is capture-verified but not yet hardware-tested by us
