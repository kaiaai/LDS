...
- 3irobotix Delta-2C PRO - use `LDS_DELTA_2C_115200`. Protocol version 0x13 with an extra end_angle field (differs from Delta-2A); distance scale 0.25 mm/unit as in the rest of the Delta family. Contributed by [sylvan-he](https://github.com/hapynfdj) from the [delta2c-lidar](https://github.com/hapynfdj/delta2c-lidar) reverse-engineering toolkit ([issue #16](https://github.com/kaiaai/LDS/issues/16), [discussion #95](https://github.com/makerspet/support/discussions/95)); protocol verified byte-exact against real captures from two units, but not tested on hardware by us
